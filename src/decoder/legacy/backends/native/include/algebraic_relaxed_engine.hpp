...
class AlgebraicRelaxedEngine {
 public:
  AlgebraicRelaxedEngine(
  ...
  AlgebraicRelaxedEngine(const AlgebraicRelaxedEngine&) = delete;
  AlgebraicRelaxedEngine& operator=(const AlgebraicRelaxedEngine&) = delete;
  AlgebraicRelaxedEngine(AlgebraicRelaxedEngine&&) noexcept;
  AlgebraicRelaxedEngine& operator=(AlgebraicRelaxedEngine&&) noexcept;
 ...
 private:
  std::unique_ptr<AlgebraicRelaxedSolver> impl_;
};
